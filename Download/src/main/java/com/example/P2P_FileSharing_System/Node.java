...
public class Node extends Thread {
     ...
     * TODO : allow firewall for all the ports
...
//                echo(s);
                ...
                if (command.equals("JOIN")) {  /** listens for any JOIN requests from peer nodes */
                    ...
                    String query = String.join(" ", filename.split("_"));
...
//                                    System.out.println("SAME");
                        ...
                        reply += "http://" + this.ip + ":" + test.serverPort + "/download/" + filename;
                        reply = String.format("%04d", reply.length() + 5) + " " + reply;
                    ...
                    echo(filecount + " files found in the " + ip + ":" + port + " node with " + hops + " hops. File Name: " + files + " Latency : " + latency);
...
//                echo(s);
    ...
    public void SEARCH(String query) { //change the implementation
        try {
            if (query.contains(" ")) {
                query = String.join("_", query.split(" "));
            }
    ...
    public void downloadFile(String downloadUrl, String fileName) {
        ...
        if (downloadable) {
            ...
            try {
                ...
                System.out.println("\nDownloaded File Name : " + fileName + " downloaded");
